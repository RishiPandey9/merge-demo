...
const Work = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const res = await fetch('/api/project1/data')
  ...
  return (
    <section
      id='Team'
      className="relative dark:bg-darkmode py-4 bg-cover bg-center overflow-hidden before:absolute before:w-full before:h-full before:bg-[url('/project1/images/wework/elipse.svg')] before:bg-no-repeat before:bg-center after:absolute after:w-1/3 after:h-1/3 after:bg-[url('/project1/images/wework/vector.svg')] after:bg-no-repeat after:top-28 after:-right-12 after:-z-10">
                ...
                <div className='bg-white dark:bg-darkHeroBg m-3 py-14 my-10 text-center shadow-xl rounded-3xl'>
                  <div className='relative'>
                    ...
                    <div className='absolute right-16 bottom-0 bg-white shadow-linckedin p-5 rounded-full'>
                      <Image
                        src={'/project1/images/wework/linkedin.svg'}
                        alt='greenbg'
                        width={30}
                        height={30}
