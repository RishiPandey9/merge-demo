  ...
  return (
    <section className='relative bg-cover bg-center overflow-hidden'>
      <div className='container mx-auto max-w-7xl px-4'>
        <div className="rounded-3xl bg-primary bg-[url('/project1/images/digital/bg.svg')] bg-no-repeat bg-right-top lg:pb-60 pb-32 relative">
          ...
          <div className='absolute -bottom-16 -right-20 xl:block hidden'>
            <Image
              src='/project1/images/digital/girldoodle.svg'
              alt='doodle'
              width={815}
              height={691}
            />
