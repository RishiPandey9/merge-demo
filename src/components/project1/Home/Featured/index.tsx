...
const Featured = () => {
  ...
  return (
    <section className="relative bg-deepSlate dark:bg-darkmode  after:absolute after:w-1/4 after:h-1/4 after:bg-[url('/project1/images/wework/vector.svg')]  after:top-72 after:right-0 after:bg-no-repeat">
