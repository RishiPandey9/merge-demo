...
import SignUp from '@/components/project1/Auth/SignUp'
        ...
        <div
          ...
          <div className='flex items-center justify-between p-4'>
            ...
            <button
              ...
              className="bg-[url('/project1/images/closed.svg')] bg-no-repeat bg-contain w-5 h-5 absolute top-0 right-0 mr-8 mt-8 dark:invert"
