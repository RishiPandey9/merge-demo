...
import Logo from '@/components/project1/Layout/Header/Logo'
import { useState } from 'react'
import Loader from '@/components/project1/Common/Loader'
const SignUp = () => {
  ...
  return (
    <>
      ...
      <p className='text-body-secondary mb-4 text-black text-base'>
        ...
        <a href='/project1/#' className='text-primary hover:underline'>
          Privacy
        </a>{' '}
        and{' '}
        <a href='/project1/#' className='text-primary hover:underline'>
      ...
      <p className='text-body-secondary text-black text-base'>
        ...
        <Link href='/project1/signin' className='pl-2 text-primary hover:underline'>
          Sign In
        </Link>
      </p>
    </>
