  ...
  useEffect(() => {
    const verifyToken = async () => {
      try {
        ...
        router.push('/project1/forgot-password')
      }
    }
          ...
          <div className='w-full px-4'>
            <div
              ...
              <div className='mb-10 text-center'>
                <Link href='/project1/' className='mx-auto inline-block max-w-[160px]'>
                  <Image
                    src='/project1/images/logo/logo.svg'
                    alt='logo'
                    width={140}
                    height={30}
                  ...
                  />
                  <Image
                    src='/project1/images/logo/logo-white.svg'
                    alt='logo'
                    width={140}
                    height={30}
