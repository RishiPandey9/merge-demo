...
import Logo from "@/components/project3/Layout/Header/Logo"
import { useContext, useState } from "react";
import Loader from "@/components/project3/Common/Loader";
  ...
  return (
    <>
      ...
      <p className="text-body-secondary mb-4 text-base">
        ...
        <a href="/project3/#" className="text-primary hover:underline">
          Privacy
        </a>{" "}
        and{" "}
        <a href="/project3/#" className="text-primary hover:underline">
