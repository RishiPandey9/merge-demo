...
const Hero = () => {
  return (
    <>
      <section className="relative overflow-x-clip top-0 bg-primary circalanimat before:content-[''] before:absolute before:bg-[url('/project3/images/work-grow/work-line.png')] before:bg-no-repeat before:bg-contain before:w-44 before:h-20 before:bottom-40 lg:before:inline-block before:hidden">
            ...
            <div className='flex flex-wrap'>
              <div
                ...
                <div className='flex items-center gap-6'>
                  <div>
                    <Image
                      src='/project3/images/hero/wise_white.png'
                      alt='logo'
                      width={0}
                      height={0}
                      quality={100}
                  ...
                  <div>
                    <Image
                      src='/project3/images/hero/google_white.png'
                      alt='logo'
                      width={0}
                      height={0}
                      quality={100}
                  ...
                  <div>
                    <Image
                      src='/project3/images/hero/pay_white.png'
                      alt='logo'
                      width={0}
                      height={0}
                      quality={100}
                  ...
                  <div>
                    <Image
                      src='/project3/images/hero/stripe_white.png'
                      alt='logo'
                      width={0}
                      height={0}
                      quality={100}
              ...
              <div
                className="md:w-1/4 w-full md:-ml-16 -ml-0 relative z-1 before:absolute before:content-[''] before:bg-[url('/project3/images/hero/grid-line.png')] before:bg-no-repeat before:w-24 before:h-24 before:-top-32 before:-right-16 lg:before:inline-block before:hidden after:content-[''] after:absolute after:bg-[url('/project3/images/hero/circal.png')] after:bg-no-repeat after:w-[2.625rem] after:h-[2.625rem] after:top-10 after:-left-[8.25rem] xl:after:inline-block after:hidden"
                data-aos='fade-left'
                data-aos-delay='200'
                data-aos-duration='1000'>
                <form>
