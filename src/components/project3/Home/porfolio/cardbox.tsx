          ...
          <div className='flex md:flex-nowrap flex-wrap items-stretch justify-center gap-8'>
            <div className='flex items-stretch flex-col gap-8 w-full'>
              <div className='mb-4'>
                ...
                <div className=''>
                  <Link href='/project3/' className='btn'>
                ...
                if (index % 2 === 1) {
                  return (
                    <div
                      ...
                      className={
                        index === 1
                          ? "relative before:absolute before:content-[''] before:bg-[url('/project3/images/work-grow/work-line.png')] before:bg-no-repeat before:bg-contain before:w-183 before:h-20 before:bottom-24 before:-left-24 lg:before:inline-block before:hidden"
                          : ''
                      }
                      data-aos='fade-up'
