...
import { SuccessfullLogin } from '@/components/project3/Auth/AuthDialog/SuccessfulLogin'
import { FailedLogin } from '@/components/project3/Auth/AuthDialog/FailedLogin'
import { UserRegistered } from '@/components/project3/Auth/AuthDialog/UserRegistered'
import AuthDialogContext from '@/context/project3/AuthDialogContext'
    ...
    <>
      <header
        ...
        <div className='container mx-auto flex items-center justify-between p-6'>
          <Link href='/project3/'>
            <Image
              src='/project3/images/logo/logo.svg'
              alt='logo'
              width={160}
              height={50}
