...
import { sections } from '@/app/api/project3/data'
...
const Footer: FC = () => {
  ...
  return (
    <footer
      className={`relative dark:bg-darkmode bg-[url('/project3/images/footer/ftr-bg.png')] bg-cover bg-no-repeat w-full h-full ${
      ...
      <div className='bg-secondary md:pb-20 pb-8'>
        <div className='container'>
          <div className='flex items-center justify-between pb-16 border-b border-dark_border border-solid'>
            <Link href='/project3/'>
              <Image
                src='/project3/images/footer/ftr-logo.svg'
                alt='Company logo'
                width={160}
                height={50}
            ...
            <div>
              <ul className='flex items-center gap-5'>
                <li>
                  <Link href='/project3/' aria-label='Facebook'>
                    <svg
                      width='26'
                      height='27'
                      fill='white'
                ...
                <li>
                  <Link href='/project3/' aria-label='Twitter'>
                    <svg
                      width='26'
                      height='27'
                      viewBox='0 0 26 27'
                ...
                <li>
                  <Link href='/project3/' aria-label='LinkedIn'>
                    <svg
                      width='26'
                      height='28'
                      viewBox='0 0 26 28'
            ...
            <div className='col-span-3'>
              ...
              <div className='relative flex'>
                ...
                <button
                  ...
                  aria-label='Submit'>
                  <i className="bg-[url('/project3/images/footer/msg-enter.svg')] bg-contain w-5 h-5 inline-block"></i>
                </button>
              </div>
