          ...
          <div className='flex md:flex-row flex-col items-stretch justify-start sm:gap-28 gap-8'>
            <div className='flex sm:flex-row flex-col items-start sm:gap-8 gap-4'>
              <div className='bg-primary/20 dark:bg-darklight w-14 h-14 flex items-center justify-center rounded-full'>
                <i className="bg-[url('/project3/images/contact/email.svg')] bg-no-repeat bg-contain w-8 h-8 inline-block"></i>
              </div>
              <div>
                ...
                <div>
                  <Link
                    ...
                    Leave a message
                    <i className="bg-[url('/project3/images/contact/arrow.svg')] bg-no-repeat bg-contain inline-block w-6 h-4 group-hover:bg-[url('/project3/images/contact/arrow-hover.svg')] dark:group-hover:bg-[url('/project3/images/contact/arrow-hover-white.svg')]"></i>
                  </Link>
                </div>
              </div>
            </div>
            <div className='flex sm:flex-row flex-col items-start sm:gap-8 gap-4'>
              <div className='bg-primary/20 dark:bg-darklight w-14 h-14 flex items-center justify-center rounded-full'>
                <i className="bg-[url('/project3/images/contact/Career.svg')] bg-no-repeat bg-contain w-8 h-8 inline-block"></i>
              </div>
