...
export default function ScrollToTop() {
  ...
  return (
    ...
    >
      <div className="before:content-[''] before:absolute before:w-8 before:h-8 before:bg-[url('/project3/images/footer/top-arrow.svg')] before:bg-no-repeat before:bg-cover"></div>
    </div>
  );
}