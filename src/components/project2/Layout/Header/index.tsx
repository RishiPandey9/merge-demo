...
import Signin from "@/components/project2/Auth/SignIn";
import SignUp from "@/components/project2/Auth/SignUp";
          ...
          {user?.user || session?.user ? (
            <>
              <div className="relative group flex items-center justify-center">
                <Image
                  src="/project2/images/profile.png"
                  alt="Image"
                  width={35}
                  height={35}
                  quality={100}
