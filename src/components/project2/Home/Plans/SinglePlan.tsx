...
const SinglePlan = ({ plan, onSelect }: SinglePlanProps) => {
    ...
    return (
        <div className="xl:col-span-4 md:col-span-6 col-span-12" >
            <div className="shadow-card-shadow relative h-full sm:px-15 px-6 sm:pt-3.438 sm:pb-12 sm:py-0 py-9 rounded-3xl before:content-[''] before:absolute before:w-full before:h-11.563 before:bg-contain before:bg-center before:bg-no-repeat before:bg-[url('/project2/images/plan/price-overlay.svg')] dark:before:bg-[url('/project2/images/plan/price-overlay-dark.svg')] before:top-20% before:right-0 bg-white dark:bg-darklight z-1 flex flex-col justify-between lg:mb-0 mb-1.875">
                <div className="">
