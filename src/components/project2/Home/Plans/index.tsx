...
import Logo from "@/components/project2/Layout/Header/Logo";
...
const Plan = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const res = await fetch('/api/project2/data')
  ...
  return (
    <section className="relative bg-contain bg-no-repeat bg-[url('/project2/images/plan/price-plan-background-icons.svg')] bg-center dark:bg-darkmode">
