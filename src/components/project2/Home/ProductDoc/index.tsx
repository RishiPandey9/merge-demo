...
const ProductDoc = () => {
  ...
  return (
    <section className="bg-blue relative bg-[url(/project2/images/productdoc/portfolio-backoverlay.svg)] bg-center bg-no-repeat bg-contain">
