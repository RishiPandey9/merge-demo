...
import nextImg from "/public/project2/images/documentation/Categories=Nextjs.svg"
import reactImg from "/public/project2/images/documentation/Categories=React.svg"
import tailwindImg from "/public/project2/images/documentation/Categories=Tailwind.svg"
import nextauthImg from "/public/project2/images/documentation/nextauth.png"
import typescriptImg from "/public/project2/images/documentation/Categories=Typescript.svg"
import axiosImg from "/public/project2/images/documentation/axios.svg"
  ...
  return (
    <>
      <div id="version" className="md:scroll-m-[180px] scroll-m-28">
        ...
        <div className="mt-5">
          <p className="text-base font-medium text-midnight_text dark:text-white dark:text-opacity-50">SaasCandy Tailwind NextJs Template is built with Tailwindcss and Nextjs.</p>
