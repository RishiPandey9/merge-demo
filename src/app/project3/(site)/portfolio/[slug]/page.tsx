...
import PortfolioSlider from '@/components/project3/Portfolio_detail/PortfolioSlider'
  ...
  return (
    <>
        ...
        <div className='container'>
          ...
          <div className='md:pt-24 pt-10'>
            <div className='flex md:flex-nowrap flex-wrap items-center gap-10'>
              <Image
                src='/project3/images/portfolio-details/font-1.jpg'
                alt='Portfolio'
                width={0}
                height={0}
                quality={100}
              ...
              />
              <Image
                src='/project3/images/portfolio-details/font-2.jpg'
                alt='Portfolio'
                width={0}
                height={0}
                quality={100}
      ...
      <div className='dark:bg-darkmode grid lg:grid-cols-2 grid-cols-1 md:gap-20 gap-4 items-center border-t border-solid border-AliceBlue dark:border-dark_border lg:px-0 px-7'>
        <div>
          <Image
            src='/project3/images/portfolio-details/work-process.png'
            alt='Portfolio'
            width={0}
            height={0}
            quality={100}
          ...
          <div className='flex flex-wrap justify-between items-center'>
            <div>
              <div className='inline-flex flex-wrap items-center md:gap-24 gap-4'>
                ...
                <Image
                  src='/project3/images/portfolio-details/quote.png'
                  alt='Portfolio'
                  width={0}
                  height={0}
                  quality={100}
            ...
            <div>
              <Image
                src='/project3/images/portfolio-details/1a4f4281fd2cd22b7d1785419c5813de.png'
                alt='Portfolio'
                width={0}
                height={0}
                quality={100}
