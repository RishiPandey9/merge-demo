import Blog from '@/components/project3/SharedComponent/Blog'
import { getAllPosts, getPostBySlug } from '@/utils/project3/markdown'
import markdownToHtml from '@/utils/project3/markdownToHtml'
...
export async function generateMetadata({ params }: any) {
  ...
  const siteName = process.env.PROJECT3_SITE_NAME || 'Your Site Name'
  const authorName = process.env.PROJECT3_AUTHOR_NAME || 'Your Author Name'
