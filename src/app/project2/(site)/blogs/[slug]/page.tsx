import { getAllPosts, getPostBySlug } from "@/utils/project2/markdown";
import markdownToHtml from "@/utils/project2/markdownToHtml";
...
export async function generateMetadata({ params }: any) {
  ...
  const siteName = process.env.PROJECT2_SITE_NAME || "Your Site Name";
  const authorName = process.env.PROJECT2_AUTHOR_NAME || "Your Author Name";
